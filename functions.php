...
if ( ! function_exists( 'dmenta_theme_setup' ) ) :
    ...
    function dmenta_theme_setup() {
        ...
        add_theme_support(
            'custom-background',
            apply_filters(
                'dmenta_theme_custom_background_args',
                array(
 ...
 */
function dmenta_theme_content_width() {
    $GLOBALS['content_width'] = apply_filters( 'dmenta_theme_content_width', 640 );
}
add_action( 'after_setup_theme', 'dmenta_theme_content_width', 0 );
